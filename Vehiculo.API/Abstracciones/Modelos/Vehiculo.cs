...
namespace Abstracciones.Modelos
{
    public class VehiculoBase
    {
        ...
        [RegularExpression(@"[A-Za-z]{3}-[0-9]{3}", ErrorMessage = "El formato de la placa deber ser ###-ABC")]
        ...
        [EmailAddress]
        public string CorreoPropietrario { get; set; }

        [Required(ErrorMessage = "La propiedad teléfono es requerida")]
        [Phone]
        public string TelefonoPropietairo { get; set; }
    }
